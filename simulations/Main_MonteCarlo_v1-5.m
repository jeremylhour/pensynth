...
% Version 1.5: Only one r at a time, without PureSynth
% To use for n0 = 1000 on MIT cluster
...
options = optimoptions('quadprog','StepTolerance',1e-14,'OptimalityTolerance',1e-14,'MaxIterations',2000,'Display','off');
